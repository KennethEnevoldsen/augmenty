...
def create_wordnet_synonym_augmenter(
    ...
    try:
        ...
        print(e)
        raise ModuleNotFoundError("This augmenter requires NLTK. Use `pip install nltk` or `pip install augmenty[all]`")
    ...
    return partial(wordnet_synonym_augmenter, level=level, lang=lang_dict[lang], getter=getter)
