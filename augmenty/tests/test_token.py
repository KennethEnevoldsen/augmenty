...
def test_create_conditional_token_casing_augmenter(nlp):
    ...
    aug = spacy.augmenters.get("conditional_token_casing.v1")(level = 1, lower=True, conditional=conditional)
...
def test_create_token_replace_augmenter(nlp):
    ...
    doc2 = Doc(nlp.vocab, words=["Look", "a", "flat", "door", "!"], pos = ["", "", "", "ADJ", "", ""])

    aug = spacy.augmenters.get("token_replace.v1")(level = 1, replace = {"happy": ["cheery", "joyful"], 
...
def test_create_token_swap_augmenter(nlp):
    ...
    doc1 = Doc(nlp.vocab, words=["I", "am", "happy", "!"])
    doc2 = Doc(nlp.vocab, words=["I", "am", "happy", "!"], ents = ["", "", "B-PER", "I-PER", ""])
